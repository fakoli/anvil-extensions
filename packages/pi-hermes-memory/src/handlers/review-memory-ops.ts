...
import { type Message, type SimpleStreamOptions, completeSimple } from "@earendil-works/pi-ai/compat";
...
export async function runDirectMemoryCompletion(
  ...
  try {
    ...
    const applied = await applyReviewOperations(store, projectStore, operations, dbManager, projectName, {
