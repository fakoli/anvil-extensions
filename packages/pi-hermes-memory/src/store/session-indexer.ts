...
import { type ParsedSession, getSessionFiles, parseSessionFile } from "./session-parser.js";
...
export function truncateMessageContent(content: string, maxLength = DEFAULT_MAX_MESSAGE_CONTENT_LENGTH): string {
