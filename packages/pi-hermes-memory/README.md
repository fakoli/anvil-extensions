...
```bash
# Install
pi install @schovest/pi-hermes-memory
...
Or install from the monorepo source:

```bash
pi install git:github.com/schovest/pi-package-mono
```

> This package is maintained in the [pi-package-mono](https://github.com/schovest/pi-package-mono)
> monorepo (migrated from `chandra447/pi-hermes-memory` v0.9.6).
